...
import { useLineaProduccionContext, LineaProduccionFilters } from './linea-produccion-context';

export function LineaProduccionFilter() {
  const stylebtn = useButtonsStyles();
  const { filters, setFilters, clearFilters } = useLineaProduccionContext();
  
  const [localFilters, setLocalFilters] = useState<LineaProduccionFilters>({
  ...
  const handleFilter = () => {
    ...
    const cleanFilters: LineaProduccionFilters = {};
